      ...
      <div className=" sm:flex sm:flex-1 sm:items-center sm:justify-center">
        <div>
          ...
          >
            <a
              href="#"
              className="relative inline-flex items-center rounded-l-md px-2 py-2 text-[#0D6EFD] ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
            ...
            <a
              href="#"
              className="relative inline-flex items-center rounded-r-md px-2 py-2 text-[#0D6EFD] ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
